...
module.exports = function (options) {
  ...
  var dasherizedDirectives = dasherize(directives)
  if (('report-uri' in dasherizedDirectives) && ('report-to' in dasherizedDirectives)) {
    throw new Error('report-uri and report-to cannot both be set.')
  }
}
